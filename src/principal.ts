...
let cliente1: Cliente = new Cliente("15457858", "A");
let cliente2: Cliente = new Cliente("15457859", "B");
let cliente3: Cliente = new Cliente("15457667", "C"); 

let agencia: Agencia = new Agencia(); 
