...
const cliente1: Cl_Cliente = new Cl_Cliente("Luis", 100, 2, 0, 0);
const cliente2: Cl_Cliente = new Cl_Cliente("Ana", 50, 0, 2, 1);
const cliente3: Cl_Cliente = new Cl_Cliente("José", 100, 0, 4, 2);
const cliente4: Cl_Cliente = new Cl_Cliente("Carmen", 20, 0, 0, 2);
const cliente5: Cl_Cliente = new Cl_Cliente("Eva", 50, 0, 1, 3);

const casaMoneda: Cl_CasaMoneda = new Cl_CasaMoneda(6, 10, 20);
...
const salida: HTMLElement | null = document.getElementById("salida");
if (salida) {
    salida.innerHTML =
